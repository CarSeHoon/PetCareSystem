...
export default function PetUpdate() {
  ...
  return (
    <FormStyled>
      ...
      <InputGroup size="lg" className="mb-3">
        <InputGroup.Text id="basic-addon1">동물종</InputGroup.Text>
        <Form.Control
          placeholder="PetType"
          type="text"
      ...
      <InputGroup size="lg" className="mb-3">
        <InputGroup.Text id="basic-addon1">품종</InputGroup.Text>
        <Form.Control
          placeholder="PetKind"
          type="text"
      ...
      <InputGroup size="lg" className="mb-3">
        ...
        <Form.Control
          ...
          type="file"
          accept="image/*"
          onChange={(e) => careRequestChange(e, "img_url")}
